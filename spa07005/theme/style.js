var myTheme = {
    init: function () {
        // Injection automatique du CSS global de la Forge
        if (window.location.hostname === "gbulleryahen.forge.apps.education.fr") {
            $('head').append('<link rel="stylesheet" type="text/css" href="/test-site/nav.css">');
        }
        // Common functions
